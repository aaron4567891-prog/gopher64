...
class DiagnosticsActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout.addView(TextView(this).apply {
            text = "Diagnostic logging\nEnable this, reproduce the problem, then return here to share the log. Logs survive restarting the app and may include ROM names or paths. Nothing is uploaded automatically."
        })
        ...
        button("Share log") {
            runCatching {
                ...
                startActivity(Intent.createChooser(share, "Share Gopher64 log"))
        ...
        button("Save log as…") {
            startActivityForResult(Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
                ...
                type = "text/plain"
                putExtra(Intent.EXTRA_TITLE, "gopher64-diagnostics.txt")
            }, 20)
        }
        button("Clear logs") {
